<template>
  <div class="container mx-auto">
    <div class="relative text-gray-800 ml-4 mr-4 flex mb-2">
       <input v-model="searchQuery" type="search" name="search" placeholder="Goalie Search" class="h-10 px-5 pr-10 placeholder-gray-400 text-gray-600 relative bg-white rounded text-sm border border-gray-300 outline-none focus:outline-none w-full pl-10">
