    ...
    <div class="content text-3xl text-center md:text-left">
      ...
      >
        <div class="sm:text-center lg:text-left">
          ...
          >
            Welcome to the home of hockey dfs news, lineup and betting content. Sign up for the upcoming newsletter to receive our weekly top lineup & player prop selections.
          </p>
